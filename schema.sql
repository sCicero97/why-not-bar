...
-- Reset completo del evento (admin only). Atómico, bypassa RLS.
...
begin
  ...
  update bar_accounts
     set total = 0, qty160 = 0, qty260 = 0, qty360 = 0, is_closed = false
   where event_id = p_event_id;
  update attendees
     set entered = false, entry_time = null, exit_time = null,
